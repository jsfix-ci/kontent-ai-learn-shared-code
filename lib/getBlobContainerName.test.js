...
const getBlobContainerName_1 = require("./getBlobContainerName");
describe('getBlobContainerName', () => {
    it('gets the name from event correctly', () => {
        ...
        const containerName = getBlobContainerName_1.getBlobContainerName(eventGridEvent);
        expect(containerName).toEqual(expectedContainerName);
    });
});
//# sourceMappingURL=getBlobContainerName.test.js.map